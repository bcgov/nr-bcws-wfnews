...
include.tag("layer-wms-time-cql", {
  ...
  tags: [
    {
      loader: "script",
      url: "./plugin-time-dimension/layer/layer-wms-time-cql.js",
    },
  ],
});
...
include.tag("layer-image-leaflet", {
  ...
  tags: [
    {
      loader: "script",
      url: "./plugin-time-dimension/viewer-leaflet/layer/layer-image-leaflet.js",
    },
  ],
});
...
include.tag("layer-wms-time-cql-leaflet", {
  ...
  tags: [
    {
      loader: "script",
      url: "./plugin-time-dimension/viewer-leaflet/layer/layer-wms-time-cql-leaflet.js",
    },
  ],
});
...
include.tag("tool-time-dimension", {
  ...
  tags: [
    {
      loader: "script",
      url: "./plugin-time-dimension/tool/time-dimension/tool-time-dimension.js",
    },
  ],
});
...
include.tag("tool-time-dimension-leaflet", {
  ...
  tags: [
    ...
    {
      loader: "script",
      url: "./plugin-time-dimension/viewer-leaflet/tool/time-dimension/lib/time-dimension-layer-image-overlay.js",
    },
    {
      loader: "script",
      url: "./plugin-time-dimension/viewer-leaflet/tool/time-dimension/tool-time-dimension-leaflet.js",
    },
  ],
});

include("layer-image-leaflet");
include("layer-wms-time-cql-leaflet");
