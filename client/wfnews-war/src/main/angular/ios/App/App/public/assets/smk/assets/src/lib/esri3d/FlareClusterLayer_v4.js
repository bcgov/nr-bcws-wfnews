  ...
  var FlareClusterLayer = /** @class */ (function (_super) {
    ...
    FlareClusterLayer.prototype._createSingle = function (obj) {
      ...
      function addGraphic(symbol) {
        ...
        if (!symbol)
          graphic.symbol = self.singleRenderer.getSymbol(
            graphic,
            self._activeView,
          );
        self.add(graphic);
    ...
    FlareClusterLayer.prototype._viewPointerMove = function (evt) {
      ...
      if (this._activeCluster && this._activeCluster.clusterGroup) {
        var bbox =
          this._activeCluster.clusterGroup.rawNode.getBoundingClientRect();
    ...
    FlareClusterLayer.prototype._getOffsetPoint = function (x, y) {
      ...
      if (this._activeView.container.offsetTop) {
        ...
        if (
          this._activeView.container.offsetParent &&
          this._activeView.container.offsetParent["offsetTop"]
        ) {
      ...
      if (this._activeView.container.offsetLeft) {
        ...
        if (
          this._activeView.container.offsetParent &&
          this._activeView.container.offsetParent["offsetLeft"]
        ) {
          ...
          switch (_a.label) {
            case 0:
              ...
              this._activeCluster.clusterGroup =
                surface.containerGroup.createGroup();
            ...
            case 1:
              ...
              this._clusterClickHandler = on(
                clonedClusterElement,
                "click",
                function () {
                  return _this._clusterClicked(_this._activeCluster);
                },
              );
              return [
                4 /*yield*/,
          ...
          switch (_c.label) {
            case 0:
              ...
              if (
                ...
                this._flareClickHandlers.length > 0
              ) {
                for (
                  _i = 0, _a = this._flareClickHandlers;
                  _i < _a.length;
                  _i++
                ) {
                  fch = _a[_i];
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      ...
                      f.flareGroup =
                        this_1._activeCluster.clusterGroup.createGroup();
                    ...
                    case 1:
                      ...
                      this_1._flareClickHandlers.push(
                        on(flareElement, "click", function () {
                          return _this._flareClicked(f);
                        }),
                      );
