...
export class IncidentDetailsPanel {
  ...
  causeOptions: OptionDisclaimer[] = [
    {id:0, optionValue: "General", disclaimer:"The cause of a wildfire is determined by professional investigations. The BC Wildfire Service employs Fire Origin and Cause Specialists to conduct investigations in accordance with international standards. Learn more about what causes wildfires here."},
    {id:1, optionValue: "Lightning", disclaimer:"When lightning strikes an object it can release enough heat to ignite a tree or other fuels."},
    {id:2, optionValue: "Human", disclaimer:"Humans start wildfires in several ways, either by accident or intentionally."},
