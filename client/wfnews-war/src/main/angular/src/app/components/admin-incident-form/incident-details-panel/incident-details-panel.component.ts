...
export class IncidentDetailsPanel {
  ...
  causeOptions: OptionDisclaimer[] = [
    {optionValue: "General", disclaimer:"The cause of a wildfire is determined by professional investigations. The BC Wildfire Service employs Fire Origin and Cause Specialists to conduct investigations in accordance with international standards."},
