export const CauseOptionDisclaimer = {
  ...
  3: 'Wildfire investigations often take time and can be very complex. Investigations may be carried out by one or more agencies, including the BC Wildfire Service, the Natural Resource Officer Service, the RCMP, or other law enforcement agencies, and may be cross jurisdictional.',
};
