...
import { IncidentInfoPanel } from './incident-info-panel.component';
...
export default {
  ...
  decorators: [
    moduleMetadata({
      declarations: [IncidentInfoPanel],
      imports: [CommonModule, MatIconModule, MatButtonModule],
    }),
  ],
} as Meta<IncidentInfoPanel>;

type Story = StoryObj<IncidentInfoPanel>;
