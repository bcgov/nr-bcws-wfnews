...
export const INFORMATION_TEXTS = {
  ...
  BANS_DECISION_INFO: `Fire bans (prohibitions) apply to land specified in legal orders and information bulletins issued by the BC Wildfire Service. <br><br>Decisions on when and where to implement fire bans and are made by B.C.’s regional fire centres depending on local fire hazards, forecasted weather conditions and the type and level of fire activity occurring.`,
