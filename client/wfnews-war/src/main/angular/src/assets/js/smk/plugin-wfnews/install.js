...
include.tag( "layer-wms-time-cql",
    { loader: "group", tags: [
        { loader: "script", url: "./plugin-time-dimension/layer/layer-wms-time-cql.js" }
    ] }
);
...
include.tag( "layer-wms-time-cql-leaflet",
    { loader: "group", tags: [
        { loader: "script", url: "./plugin-time-dimension/viewer-leaflet/layer/layer-wms-time-cql-leaflet.js" }
    ] }
);
