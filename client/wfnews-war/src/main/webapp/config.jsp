...
<%
  ...
  if (properties != null) {
    ...
    json.append("\"externalAppConfig\":{");
      ...
      json.append("\"AGOLfireZoneBoundaries\":\"").append("https://services6.arcgis.com/ubm4tcTYICKBpist/ArcGIS/rest/services/British_Columbia_Fire_Zone_Boundaries/FeatureServer/0/").append("\",");
