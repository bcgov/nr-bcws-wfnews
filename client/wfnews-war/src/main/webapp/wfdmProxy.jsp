...
<%@ page import="ca.bc.gov.webade.oauth2.rest.v1.token.client.impl.TokenServiceImpl" %>
<%! org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger("wfdmBytes"); %>
<%
  
  ApplicationContext context =  WebApplicationContextUtils.getWebApplicationContext(application);
  //TokenServiceImpl tokenClient = context.getBean(TokenServiceImpl.class);
  Properties applicationProperties = (Properties)context.getBean("applicationProperties");
  ...
  try {
      ...
      String baseUrl = (String) applicationProperties.get("wildfire.attachment.wfdm.url");
