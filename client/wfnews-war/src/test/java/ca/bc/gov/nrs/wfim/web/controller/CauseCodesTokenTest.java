...
public class CauseCodesTokenTest extends EndpointsTest {
	
	private static final Logger logger = LoggerFactory.getLogger(CauseCodesTokenTest.class);
	...
	public void testToken() throws IOException {
		...
		URL url = new URL(topLevelURL+"causeCodes/token.jsp");
