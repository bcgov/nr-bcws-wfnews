...
for incident in wfim_incidents:
  ...
  feature = {
    ...
    "traditionalTerritoryDetail": published_incident['traditionalTerritoryDetail'] if published_incident is not None else '',
    "incidentSizeType": published_incident['incidentSizeType'] if published_incident is not None else '',
    "incidentSizeDetail": published_incident['incidentSizeDetail'] if published_incident is not None else '',
    "incidentCauseDetail": published_incident['incidentCauseDetail'] if published_incident is not None else '',
    ...
    "resourceDetail": published_incident['resourceDetail'] if published_incident is not None else '',
    ...
    "wildfireCrewResourcesDetail": published_incident['wildfireCrewResourcesDetail'] if published_incident is not None else '',
    ...
    "wildfireAviationResourceDetail": published_incident['wildfireAviationResourceDetail'] if published_incident is not None else '',
    ...
    "heavyEquipmentResourcesDetail": published_incident['heavyEquipmentResourcesDetail'] if published_incident is not None else '',
    ...
    "incidentMgmtCrewRsrcDetail": published_incident['incidentMgmtCrewRsrcDetail'] if published_incident is not None else '',
    ...
    "structureProtectionRsrcDetail": published_incident['structureProtectionRsrcDetail'] if published_incident is not None else '',
    "publishedTimestamp": published_incident['publishedTimestamp'] if published_incident is not None else curr_time,
    "publishedUserTypeCode": published_incident['publishedUserTypeCode'] if published_incident is not None else '', 
    "publishedUserGuid": published_incident['publishedUserGuid'] if published_incident is not None else '',
    "publishedUserUserId": published_incident['publishedUserUserId'] if published_incident is not None else '',
    "publishedUserName": published_incident['publishedUserName'] if published_incident is not None else '',
