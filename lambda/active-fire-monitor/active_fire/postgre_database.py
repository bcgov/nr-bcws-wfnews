...
def insert_current_fetched_time_stamp(monitor_name, fetched_time_stamp):
    ...
    try:
        ...
        sys_time_stamp = datetime.now(gmt)
        ...
        record_to_insert = (monitor_name, fetched_time_stamp, 1, "COALESCE", sys_time_stamp, "COALESCE",
                            sys_time_stamp)
...
def update_last_fetched_time_stamp(monitor_name, fetched_time_stamp):
    ...
    try: 
        ...
        cur.execute(sql, (fetched_time_stamp, sys_time_stamp, monitor_name))
