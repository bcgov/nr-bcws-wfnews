...
export class CurrentStatsComponent implements OnInit {
  ...
  private async loadData (): Promise<any> {
    ...
    const outIncidents = await this.fetchPublishedIncidents(0, 9999, false, true).toPromise()
    const outFoNIncidents = await this.fetchPublishedIncidents(0, 9999, true, true).toPromise()
