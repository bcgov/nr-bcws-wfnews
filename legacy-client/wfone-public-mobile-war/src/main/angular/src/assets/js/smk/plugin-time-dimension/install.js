...
include.tag("layer-vector-legend",
    { loader: "group", tags: [
            { loader: "script", url: "./plugin-time-dimension/layer/layer-vector-legend.js" }
        ] }
);
...
include.tag("layer-vector-legend-leaflet",
    {
        loader: "group", tags: [
            { loader: "script", url: "./plugin-time-dimension/viewer-leaflet/layer/layer-vector-legend-leaflet.js" }
        ]
    }
);
...
include('layer-vector-legend-leaflet')
