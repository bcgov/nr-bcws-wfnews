...
public class ApplicationInitializer extends AbstractSecurityWebApplicationInitializer {
    ...
    protected void beforeSpringSecurityFilterChain(ServletContext servletContext) {
    	...
    	servletContext.getAttribute(PAR_NAME_CTX_CONFIG_LOCATION);
...
//       FilterRegistration.Dynamic requestMetricsFilter = ((javax.servlet.FilterRegistration.Dynamic)servletContext).addFilter("Request Metrics Filter", RequestMetricsFilter.class);
//        requestMetricsFilter.setInitParameter("id_source", "WFNEWSAPI");
