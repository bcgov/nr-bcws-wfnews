...
public interface PublicPublishedIncidentEndpoint extends BaseEndpoints{
	...
	public Response getPublishedIncidentList( 
		...
		@ApiParam("Filter on fires that have discovery dates greater than this date with date format (yyyy-MM-dd HH:mm:ss.SSSSSS)") @QueryParam("discoveryDateGreaterThan") String discoveryDateGreaterThan,
		@ApiParam("Filter on fires that have create dates greater than this date with date format (yyyy-MM-dd HH:mm:ss.SSSSSS)") @QueryParam("createDateGreaterThan") String createDateGreaterThan,
