...
public class ExternalUriEndpointImpl extends WfNewsBaseEndpointsImpl implements ExternalUriEndpoint {
	...
	public Response createExternalUri(ExternalUriResource resource)
		...
		try {
			...
			PublishedIncidentResource incident = incidentsService.getPublishedIncident(
					result.getSourceObjectUniqueId(), null, getWebAdeAuthentication(), getFactoryContext());
