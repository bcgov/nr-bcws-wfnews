...
public class StatisticsEndpointImpl extends WfNewsBaseEndpointsImpl implements StatisticsEndpoint {
  ...
  public Response getStatistics(String fireCentre, Integer fireYear) throws NotFoundException, ForbiddenException, ConflictException {
    ...
    for (String keyword : sqlKeywords) {
        if (fireCentre != null && (fireCentre.contains(keyword) || fireCentre.contains("'"))) {
