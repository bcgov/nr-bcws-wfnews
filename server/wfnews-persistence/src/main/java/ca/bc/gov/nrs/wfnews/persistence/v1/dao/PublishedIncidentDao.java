...
public interface PublishedIncidentDao extends Serializable {
	...
	PagedDtos<PublishedIncidentDto> select(String searchText, Integer pageNumber, Integer pageRowCount, List<String> orderBy, Boolean fireOfNote, Boolean out, Boolean newFires, String fireCentre, String bbox, Double latitude, Double longitude, Double radius) throws DaoException;
