...
public class IncidentsServiceImpl extends BaseEndpointsImpl implements IncidentsService {
	...
	public PublishedIncidentListResource getPublishedIncidentList(String searchText, Integer pageNumber,
			Integer pageRowCount, String orderBy, Boolean fireOfNote, List<String> stageOfControlList, Boolean newFires, String fireCentreCode, String fireCentreName, Date discoveryDate, Date createDate, String bbox,
		...
		try {
			...
			publishedIncidentList = this.publishedIncidentDao.select(searchText, pageNumber, pageRowCount, orderByList,
					fireOfNote, stageOfControlList, newFires, fireCentreCode, fireCentreName, discoveryDate, createDate, bbox, latitude, longitude, fireYear, radius);
