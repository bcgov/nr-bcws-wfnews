...
import ca.bc.gov.nrs.wfone.notification.push.api.rest.test.FirebaseTestOverrideConfig;
import ca.bc.gov.nrs.wfone.notification.push.api.rest.v1.jersey.JerseyApplication;
import ca.bc.gov.nrs.wfone.notification.push.api.rest.v1.spring.EndpointsSpringConfig;
	...
	public static void startIfRequired(int port, String contextPath, Map<String, DataSource> dataSources) throws Exception {
		...
		if (container == null) {
			...
			DeploymentContext deploymentContext = ServletDeploymentContext.builder(JerseyApplication.class)
					...
					.contextParam("contextConfigLocation", EndpointsSpringConfig.class.getName() + " " + FirebaseTestOverrideConfig.class.getName())
