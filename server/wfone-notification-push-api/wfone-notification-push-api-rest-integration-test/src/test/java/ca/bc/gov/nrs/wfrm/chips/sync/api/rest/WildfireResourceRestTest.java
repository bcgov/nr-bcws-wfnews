package ca.bc.gov.nrs.wfrm.chips.sync.api.rest;
...
public class WildfireResourceRestTest {
	...
	private static WildfireNotificationPushService service;
	...
	public static void beforeClass() throws Exception {
...

		{
			...
			service = new WildfireNotificationPushServiceImpl("Bearer " + token.getAccessToken());
