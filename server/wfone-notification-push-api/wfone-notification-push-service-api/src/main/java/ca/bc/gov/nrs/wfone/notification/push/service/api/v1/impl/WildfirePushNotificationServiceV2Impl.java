...
public class WildfirePushNotificationServiceV2Impl implements WildfirePushNotificationServiceV2 {
	...
	static {
		...
		result.put(NotificationTopics.BRITISH_COLUMBIA_BANS_AND_PROHIBITION_AREAS, "There is a new fire prohibition in %s Fire Centre near your saved location %s. Tap for more info.");
