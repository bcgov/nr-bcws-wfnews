...
generate "dev_tfvars" {
  ...
  contents          = <<-EOF
    ...
    //   ASYNC_JOB_INTERVAL: "$ {get_env("ASYNC_JOB_INTERVAL")}"
    //   ASYNC_JOB_REF_LAT: "$ {get_env("ASYNC_JOB_REF_LAT")}"
    //   ASYNC_JOB_REF_LONG: "$ {get_env("ASYNC_JOB_REF_LONG")}"
    //   ASYNC_JOB_REF_RADIUS: "$ {get_env("ASYNC_JOB_REF_RADIUS")}"
    ...
    //   WFARCGIS_QUEUESIZE: "$ {get_env("WFARCGIS_QUEUESIZE")}"
    //   WEBADE_OAUTH2_CLIENT_ID: "$ {get_env("WEBADE_OAUTH2_CLIENT_ID")}"
    //   WEBADE_OAUTH2_TOKEN_URL: "$ {get_env("WEBADE_OAUTH2_TOKEN_URL")}"
    //   WEBADE_OAUTH2_CLIENT_SCOPES: "$ {get_env("WEBADE_OAUTH2_CLIENT_SCOPES")}"
    //   FIREWEATHER_BASEURL: "$ {get_env("FIREWEATHER_BASEURL")}"
    //   FIREWEATHER_QUEUESIZE: "$ {get_env("FIREWEATHER_QUEUESIZE")}"
    //   WFNEWS_BASEURL: "$ {get_env("WFNEWS_BASEURL")}"
