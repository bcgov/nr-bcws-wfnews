...
generate "dev_tfvars" {
  ...
  contents          = <<-EOF
    ...
    WFONE_NOTIFICATIONS_API_WEBADE_OAUTH2_CHECK_TOKEN_URL = "${local.WFONE_NOTIFICATIONS_API_WEBADE_OAUTH2_CHECK_TOKEN_URL}"
    WFONE_NOTIFICATIONS_API_WEBADE_OAUTH2_TOKEN_CLIENT_URL = "${local.WFONE_NOTIFICATIONS_API_WEBADE_OAUTH2_TOKEN_CLIENT_URL}"
    WFONE_NOTIFICATIONS_API_WEBADE_OAUTH2_TOKEN_URL = "${local.WFONE_NOTIFICATIONS_API_WEBADE_OAUTH2_TOKEN_URL}"
