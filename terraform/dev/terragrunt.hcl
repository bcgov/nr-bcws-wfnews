...
locals {
  ...
  WEBADE-OAUTH2_WFNEWS_REST_CLIENT_SECRET = get_env("WEBADE-OAUTH2_WFNEWS_REST_CLIENT_SECRET")
...
generate "dev_tfvars" {
  ...
  contents          = <<-EOF
    ...
    WEBADE-OAUTH2_WFNEWS_REST_CLIENT_SECRET ="${local.WEBADE-OAUTH2_WFNEWS_REST_CLIENT_SECRET}"
