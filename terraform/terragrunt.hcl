...
generate "tfvars" {
  ...
  contents          = <<-EOF
    ...
    target_aws_account_id = "${get_env("AWS_ACCOUNT_ID")}"
    ...
    google_site_verification = "${get_env("GOOGLE_SITE_VERIFICATION")}"
    gov_certificate_arn = "${get_env("GOV_CERTIFICATE_ARN")}"
    GOV_API_LEGACY_CERTIFICATE_ARN = "${get_env("GOV_API_LEGACY_CERTIFICATE_ARN")}"
    ...
    WFONE_NOTIFICATIONS_PUSH_SQS_VISIBILITY_SECONDS = "${get_env("WFONE_NOTIFICATIONS_PUSH_SQS_VISIBILITY_SECONDS")}"
    WFONE_NOTIFICATIONS_PUSH_AUDIENCE_PAGE_SIZE = "${get_env("WFONE_NOTIFICATIONS_PUSH_AUDIENCE_PAGE_SIZE")}"
    WFONE_NOTIFICATIONS_PUSH_SEND_THREADS = "${get_env("WFONE_NOTIFICATIONS_PUSH_SEND_THREADS")}"
    WFONE_NOTIFICATIONS_PUSH_FCM_PERMITS_PER_SECOND = "${get_env("WFONE_NOTIFICATIONS_PUSH_FCM_PERMITS_PER_SECOND")}"
    WFONE_NOTIFICATIONS_PUSH_EXPIRED_ITEM_DELETE_INTERVAL_SECONDS = "${get_env("WFONE_NOTIFICATIONS_PUSH_EXPIRED_ITEM_DELETE_INTERVAL_SECONDS")}"
