...
variable "WFONE_NOTIFICATIONS_PUSH_AUDIENCE_PAGE_SIZE" {
  type    = number
}

variable "WFONE_NOTIFICATIONS_PUSH_SEND_THREADS" {
  type    = number
}

variable "WFONE_NOTIFICATIONS_PUSH_FCM_PERMITS_PER_SECOND" {
  type    = number
}

variable "WFONE_NOTIFICATIONS_PUSH_EXPIRED_ITEM_DELETE_INTERVAL_SECONDS" {
  type    = number
}
